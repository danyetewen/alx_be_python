...
match priority:
    ...
    case "medium":
        if time_bound == "yes":
            ...
            print(f"Reminder: '{task}' is a medium priority task. Plan to do it within the week.")
    case "low":
        if time_bound == "yes":
            print(f"Reminder: '{task}' is a low priority task but needs to be done today due to a deadline.")
        else:
